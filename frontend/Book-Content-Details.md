...
* **The Brain:** NVIDIA Jetson Orin Nano (8GB) or Orin NX (16GB).
    * *Role:* Industry standard for embodied AI. Students deploy ROS 2 nodes here to understand resource constraints vs. powerful workstations.
* **The Eyes (Vision):** Intel RealSense D435i or D455.
    * *Role:* Provides RGB (Color) and Depth (Distance) data. Essential for VSLAM and Perception.
...
* **Voice Interface:** Simple USB Microphone/Speaker array (e.g., ReSpeaker) for "Voice-to-Action" Whisper integration.
...
* **Edge AI Kits:** Jetson Kit for physical deployment ($700 one-time).
* **Robot:** One physical robot for final demo (e.g., Unitree Go2 Standard, $3,000).
...
| **Wi-Fi** | (Included in Dev Kit) | $0 | New "Super" kit includes Wi-Fi module pre-installed. |
